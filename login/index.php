...
<html>
    ...
    <style>
        ...
        .girisback {
            ...
            width: 50%;
            height: 100%;
            background: #03A9F4 url(http://nohassls.com/static/images/pages/login/signup.jpg);
        ...
        .kayitback {
            ...
            width: 50%;
            height: 100%;
            background: #03A9F4 url(http://nohassls.com/static/images/pages/login/login.jpg);
            background-size: cover;
            background-position: 50% 50%;
        }
    ...
    <div id="textbox">
        <div class="toplam">
            ...
            <div class="left">
                <div id="ic">
                    <img src="http://nohassls.com/static/images/nohassl-logo-new.png">
                    <h2>Sign Up</h2>
                    <p>Sign up to manage your insurance requests and get access to the best deals.</p>
            ...
            <div class="right">
                <div id="ic"> 
                     <img src="http://nohassls.com/static/images/nohassl-logo-new.png" />
                    <h2>Login</h2>
                    <p>We have missed you, login to check your quotes.</p>
                    <form name="login-form" id="girisyap" id="sidebar-user-login" method="post" onsubmit="return false;">

                        <div class="form-group">
                            <label class="control-label" for="inputNormal">Username</label>
                            <input type="text" name="log" id="log" class="bp-suggestions form-control" cols="50" rows="10" ></input>
                        </div>
                        <div class="form-group soninpt">
                            <label class="control-label" for="inputNormal">Password</label>
                            <input type="password" name="pwd" id="pwd" class="bp-suggestions form-control" cols="50" rows="10"></input>
                        </div>
    ...
    <script>
                        ...
                        $('#moveright').click(function () {
                            ...
                            // focus our login field
                            $('#log').focus();
                        });

                          // set focus on docready
